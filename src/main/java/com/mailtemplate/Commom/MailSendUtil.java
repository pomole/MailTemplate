package com.mailtemplate.Commom;
...
public class MailSendUtil {
    ...
    //    发送人邮箱
    private String sendMail="2803044987@qq.com";

    //发送人昵称
    private String sendName="pomole";

    //    发送邮箱密码
    private String pwd="cxxkeyalpfbddcjf";

    //    发送人地址
    private String from="2803044987@qq.com";
...
//    发送邮件接口
    ...
    public static void main(String[] args)  throws Exception {
        ...
        Mail mail=new Mail();
        mail.setMail("2803044987@qq.com");
        mail.setTheme("theme");
